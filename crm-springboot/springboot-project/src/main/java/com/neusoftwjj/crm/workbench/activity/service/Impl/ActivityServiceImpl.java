...
import com.neusoftwjj.crm.workbench.activity.mapper.ActivityMapper;
...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public List<Activity> queryActivityByIdList(String[] ids) {
        return activityMapper.selectActivityByIdList(ids);
    }
